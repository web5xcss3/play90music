(function($) {
    ...
    `).join(''));
        ...
        // ==================================================================
        function renderDailyHit(count = 12) {
    ...
    `).join('');
        ...
        // ==================================================================
        // HOME FEATURED ESPECIAL TITULOS // EM OFF
        // ==================================================================
    ...
    `).join(''));
        ...
        function renderRecentlyPlayed() {
            ...
            const html = stored.map(entry => {
                ...
                const image = item.image || "https://i.ibb.co/Kpsfbgf8/music-default.jpg";
        ...
        function renderMusics() {
            ...
            const html = sortedMusics.map(music => {
                ...
                const image = music.image || 'https://i.ibb.co/Kpsfbgf8/music-default.jpg';
            ...
            const albumsByTitle = allAlbums.reduce((acc, album) => {
                ...
                if (!acc[album.artist]) {
                    acc[album.artist] = {
                        name: album.artist,
                        albumCount: 0,
                        image: album.image || 'https://i.ibb.co/Kpsfbgf8/music-default.jpg'
                    };
                }
